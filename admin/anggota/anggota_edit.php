...
$data = mysqli_fetch_assoc(
    mysqli_query($koneksi, "SELECT * FROM anggota WHERE id_anggota='$id'")
);
...
<head>
    ...
    <title>Edit Anggota | SI Perpustakaan</title>
        ...
        <div class="form-card">
            ...
            <form method="post" onsubmit="return validateForm()">
                ...
                <div class="form-group">
                    ...
                    <div class="form-hint">Password minimal 6 karakter (kosongkan jika tidak diubah)</div>
                </div>
                    ...
                    <div class="input-with-icon">
                        ...
                        <select name="level" id="level" required>
                            ...
                            while ($level = mysqli_fetch_assoc($query_level)) {
                                $selected = ($data['id_level'] == $level['id_level']) ? 'selected' : '';
...
function validateForm() {
    ...
    return confirm('Yakin ingin mengupdate data anggota ini?');
}
